...
const getCurrentIcon = () =>
  themeButton.classList.contains(iconThemeMoon) ? "fa-moon" : "fa-sun";

// We validate if the user previously chose a topic
if (selectedTheme) {
  document.body.classList[selectedTheme === "dark" ? "add" : "remove"](darkTheme);
  themeButton.classList.remove(iconThemeSun, iconThemeMoon);
...
themeButton.addEventListener("click", () => {
  ...
  if (themeButton.classList.contains(iconThemeSun)) {
